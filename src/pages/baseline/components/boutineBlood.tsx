...
import { BoutineBlood as FORMCONFIG } from './common';
...
const Comp = () => {
  ...
  const checkValue = Form.useWatch('isRoutineBlood', form) || '0';
  ...
  return (
    <>
      <Row>
        <Col span={14}>
          <Form form={form} onFinish={onFinish} labelCol={{span: 12}} wrapperCol={{span: 12}}>
